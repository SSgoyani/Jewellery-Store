    ...
    <>
      {loading ? (
        ...
        <>
          ...
          <h3 className="title" style={{fontFamily:'sans-serif'}}>My Profile</h3>
          <div className="profile__box">
            <div className="profile__img">
              ...
              <div className="changing__style">
                <Link
                  ...
                  id="edit_profile"
                  className="btns"
                  style={{ textDecoration: "none",fontFamily:'sans-serif' , fontWeight: 'bold', color: 'black' }}
                >
                  Edit Profile
                </Link>
                <Link
            ...
            <div className="profile__details">
              <h4 className="profile__details_title">Name</h4>
              <p className="profile__details_title_info">{user.name}</p>

              <h4 className="profile__details_title">Email</h4>
              <p className="profile__details_title_info">{user.email}</p>

              <h4 className="profile__details_title">Registration Date</h4>
