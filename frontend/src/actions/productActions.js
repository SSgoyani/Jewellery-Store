...
export const newProduct = (productData) => async (dispatch) => {
  try {
    console.log("Inside New Product", productData);
    ...
    console.log("Inside New Product 12345");
    const { data } = await axios.post(
      `/api/v1/admin/product/new`,
      productData,
      config
    );
    console.log("Inside New Product 1234567890");
    dispatch({
...
export const updateProduct = (id, productData) => async (dispatch) => {
  try {
    ...
    console.log("Inside Update Product",productData);
    const config = {
      headers: {
        "Content-Type": "application/json",
      },
